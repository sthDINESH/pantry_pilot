...
```text
"onions"      → "1 diced onion"       → likely match
"rice"        → "cooked rice"         → likely match
```
<table style="width: 100%;">
  <tr>
    ...
    <td style="width: 50%;">
      <img src="./documentation/onion_diced_recipe.png" alt="Image 2" style="width: 100%; height: auto; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
    </td>
  </tr>
</table>
