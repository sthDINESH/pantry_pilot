...
- **H2 (24px)**: Section headers, widget titles  
- **H3 (20px)**: Subsection headers, card titles
- **Body (16px)**: Main content, form labels
- **Small (14px)**: Meta information, secondary text
- **Caption (12px)**: Timestamps, helper text

##### Color Scheme Framework
- **Primary**: Green (#2E7D32) - main actions, navigation
- **Secondary**: Orange (#FF8F00) - accent, highlights
- **Success**: Green (#4CAF50) - confirmations, available items
- **Warning**: Amber (#FFC107) - low stock alerts
- **Error**: Red (#F44336) - form errors, missing items
- **Gray Scale**: #212121, #424242, #757575, #BDBDBD, #F5F5F5

##### Iconography System
- **Navigation**: Home, Pantry jar, Recipe book, Calendar, Shopping cart
- **Actions**: Plus (+), Edit (pencil), Delete (×), Save (heart), Search (magnifying glass)
- **Status**: Checkmarks (✓), X marks (❌), Stars (⭐), Clock (🕒)
- **Categories**: Emoji-based for food categories (🥬🧀🥩🌾)

##### Responsive Breakpoints
- **Mobile**: 320px - 767px (single column, bottom navigation)
- **Tablet**: 768px - 991px (2-column layout, hamburger menu)
- **Desktop**: 992px+ (full navigation, 3-column dashboard)
